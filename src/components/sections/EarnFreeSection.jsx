        ...
        <div className="flex flex-col justify-center gap-y-5 px-5">
          ...
          <div className="flex flex-wrap gap-5">
            ...
            <div className="group flex cursor-pointer gap-x-2 rounded-full border-4 border-primary bg-primary py-4 pl-8 pr-10 font-bold tracking-tighter text-lightgray transition-all duration-200 ease-in-out hover:border-lightgray hover:bg-transparent hover:text-white">
              <Image src="/playstore.svg" width={30} height={30} alt="apple icon" />
              <div className="flex flex-col text-start">
                <span className="text-xs text-white group-hover:text-darkgray">download on</span>
                <span className="text-white group-hover:text-lightgray">Google Play</span>
              </div>
            </div>
          </div>
        </div>
