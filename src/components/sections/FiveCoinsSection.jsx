const FiveCoinsSection = () => {
  return (
    <div className="flex items-center justify-center px-5 py-20">
      <div className="flex flex-wrap gap-x-14 gap-y-10 justify-center h-fit w-full max-w-7xl rounded-2xl bg-[#131519] bg-[url('/bgs/graph.png')] bg-bottom bg-no-repeat p-20">
        <div className="group relative flex cursor-pointer flex-col items-center">
          <div className="rounded-full border-4 border-darkgray p-1 opacity-80 transition-all duration-200 ease-in-out group-hover:scale-105 group-hover:border-primary">
            <div className="relative flex h-[150px] w-[150px] justify-center rounded-full border-4 border-darkgray transition-all duration-200 ease-in-out group-hover:border-primary">
              <div className="absolute top-5 h-20 w-20 text-darkgray transition-all duration-200 ease-in-out group-hover:text-primary">
                {bitcoin}
              </div>
            </div>
          </div>
          <div className="mt-5 flex flex-col gap-y-2 text-sm">
            <span className="text-3xl font-bold text-lightgray transition-all duration-200 ease-in-out group-hover:text-primary">
              Bitcoin
            </span>
            <p className="text-darkgray">
              Price: <span className="text-lightgray">$67,000</span>
            </p>
            <p className="text-darkgray">
              Cap: <span className="text-lightgray">$137B</span>
            </p>
            <span className="text-warning">25.94%</span>
          </div>
        </div>
        <div className="group relative flex cursor-pointer flex-col items-center">
          <div className="rounded-full border-4 border-darkgray p-1 opacity-80 transition-all duration-200 ease-in-out group-hover:scale-105 group-hover:border-primary">
            <div className="relative flex h-[150px] w-[150px] justify-center rounded-full border-4 border-darkgray transition-all duration-200 ease-in-out group-hover:border-primary">
              <div className="absolute top-5 h-16 w-16 text-darkgray transition-all duration-200 ease-in-out group-hover:text-primary">
                {ethereum}
              </div>
            </div>
          </div>
        ...
        <div className="group relative flex cursor-pointer flex-col items-center">
          <div className="rounded-full border-4 border-darkgray p-1 opacity-80 transition-all duration-200 ease-in-out group-hover:scale-105 group-hover:border-primary">
            <div className="relative flex h-[150px] w-[150px] justify-center rounded-full border-4 border-darkgray transition-all duration-200 ease-in-out group-hover:border-primary">
              <div className="absolute top-10 h-24 w-24 text-darkgray transition-all duration-200 ease-in-out group-hover:text-primary">
                {dogecoin}
              </div>
            </div>
          </div>
        ...
        <div className="group relative flex cursor-pointer flex-col items-center">
          <div className="rounded-full border-4 border-darkgray p-1 opacity-80 transition-all duration-200 ease-in-out group-hover:scale-105 group-hover:border-primary">
            <div className="relative flex h-[150px] w-[150px] justify-center rounded-full border-4 border-darkgray transition-all duration-200 ease-in-out group-hover:border-primary">
              <div className="absolute left-6 top-7 h-20 w-20 text-darkgray transition-all duration-200 ease-in-out group-hover:text-primary">
                {ripple}
              </div>
            </div>
          </div>
